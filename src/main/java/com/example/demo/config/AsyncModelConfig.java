...
import com.example.demo.AsyncModel;
...
public class AsyncModelConfig {
    ...
    public static class WebConfig implements WebMvcConfigurer {
        ...
        public void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
            argumentResolvers.add(new AsyncModelArgumentResolver(executorService));
        }
    }

    private record AsyncModelArgumentResolver(ExecutorService executorService)
